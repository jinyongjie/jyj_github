...
//----------------------------------------------------
 ...
 NTSYSAPI
 NTSTATUS
_stdcall NTAPI ZwQuerySystemInformation(
...
RtlFormatCurrentUserKeyPath(
 ...
 VOID _stdcall  KeStackAttachProcess (IN PEPROCESS  Process,    OUT PRKAPC_STATE  ApcState );
 VOID _stdcall  KeUnstackDetachProcess(IN PRKAPC_STATE  ApcState);
