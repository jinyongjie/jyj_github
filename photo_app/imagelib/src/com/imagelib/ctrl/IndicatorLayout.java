...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
		...
		switch (mode) {
			case PULL_UP_TO_REFRESH:
				inAnimResId = R.anim.pl_slide_in_from_bottom;
				outAnimResId = R.anim.pl_slide_out_to_bottom;
				//setBackgroundResource(R.drawable.indicator_bg_bottom);
				mArrowImageView.setImageResource(R.drawable.arrow_up);
				break;
			default:
			case PULL_DOWN_TO_REFRESH:
				inAnimResId = R.anim.pl_slide_in_from_top;
				outAnimResId = R.anim.pl_slide_out_to_top;
