...
PPROCESSINFO g_HideProcessInfo;
...
BOOL GetSystemKernelModuleInfo( __out WCHAR **SystemKernelModulePath, __out PDWORD SystemKernelModuleBase, __out PDWORD SystemKernelModuleSize);